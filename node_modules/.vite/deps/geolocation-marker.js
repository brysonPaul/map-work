...
var require_geolocation_marker = __commonJS({
  "node_modules/geolocation-marker/geolocation-marker.js"(exports) {
    (function() {
      "use strict";
      var b;
      function e(a, c) {
      ...
      function h(a, c, f, g) {
        ...
        d.a = null;
        d.i = -1;
        var l = { clickable: false, cursor: "pointer", draggable: false, flat: true, icon: { path: google.maps.SymbolPath.CIRCLE, fillColor: "#C8D6EC", fillOpacity: 0.7, scale: 12, strokeWeight: 0 }, position: new google.maps.LatLng(0, 0), title: "Current location", zIndex: 2 }, m = {
          clickable: false,
          cursor: "pointer",
          draggable: false,
          flat: true,
          icon: { path: google.maps.SymbolPath.CIRCLE, fillColor: "#4285F4", fillOpacity: 1, scale: 6, strokeColor: "white", strokeWeight: 2 },
          optimized: false,
        ...
        c && (l = k(l, c));
        f && (m = k(m, f));
        c = { clickable: false, radius: 0, strokeColor: "1bb6ff", strokeOpacity: 0.4, fillColor: "61a0bf", fillOpacity: 0.4, strokeWeight: 1, zIndex: 1 };
        g && (c = k(c, g));
        ...
        d.set("position_options", { enableHighAccuracy: true, maximumAge: 1e3 });
        d.a.bindTo("map", d.c);
        d.a.bindTo("map", d.b);
        a && d.setMap(a);
        return d;
      ...
      b.A = function(a) {
        var c = new google.maps.LatLng(a.coords.latitude, a.coords.longitude), f = !this.b.getMap();
        if (f) {
        ...
        !f && this.g() && this.g().equals(c) || google.maps.MVCObject.prototype.set.call(
          this,
          "position",
          c
        );
      ...
      var p = { map: true, position: true, radius: true }, n = /^(?:position|accuracy)$/i;
      var q = window;
      function r() {
...
export default require_geolocation_marker();
